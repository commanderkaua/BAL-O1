...
function blueBalloon() {
  var blueballoon = createSprite(0,Math.round(random(20,350)), 10, 10);
...
function greenBalloon() {
  var greenballoon = createSprite(0,Math.round(random(20,330)),10,10);
...
function pinkBalloon() {
  var pinkballoon = createSprite(0,Math.round(random(20,310)),10,10);
